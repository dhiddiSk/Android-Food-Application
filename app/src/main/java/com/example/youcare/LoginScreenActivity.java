...
//
//                dbObj = new Databaseconnectivity(this);
//
...
//
//                            boolean validUser;
//                            validUser = dbObj.verifyLogin(login_Username_value, login_password_value);
//                            if (validUser) {
//                            /*
//                            if the user is found true then pop up a message
//                             */
//                                startActivity(new Intent(LoginScreenActivity.this, SecondSeekBar.class));
//
//                            } else {
//                            /*
