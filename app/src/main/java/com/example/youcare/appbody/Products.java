...
public class Products {
    ...
    public List<Product> getProducts(){
        ...
        productsList.add(new Product("milk", "Alpro Comm", "yes", "no", "yes", "yes", 2, 1, "2", ""));
        ...
        productsList.add(new Product("banana", "Bananen Chiquita", "no", "yes", "yes", "yes", 2, 0, "1.99", ""));
        productsList.add(new Product("banana", "K-Bio Bananen", "no", "yes", "yes", "yes", 1, 0, "2.29", ""));
        productsList.add(new Product("banana", "Rewe Beste Wahl", "no", "yes", "yes", "yes", 2, 0, "1.89", ""));
        productsList.add(new Product("banana", "Bananen Baby", "no", "yes", "yes", "yes", 3, 0, "1.99", ""));
        productsList.add(new Product("banana", "Kochbananen", "no", "yes", "yes", "yes", 2, 3, "2.29", ""));
        productsList.add(new Product("banana", "Bananen", "no", "yes", "yes", "yes", 2, 3, "1.89", ""));
        productsList.add(new Product("banana", "Bananen Demeter", "no", "yes", "yes", "yes", 2, 2, "1.99", ""));
